...
def run():
    ...
    net[ 'server' ].cmd("nice -n -10 src/dash/caddy/caddy -conf /home/" + USER + "/Caddyfile -quic -mp -log caddy_log >> out &")
    ...
    if with_background == 1:
        ...
        net['client1'].cmd("nice -n -10 python3 background_sbd.py 'CLIENT' 10.0.5.2 9999 1 2 1 3000 &") 
        net['client2'].cmd("nice -n -10 python3 background_sbd.py 'CLIENT' 10.0.7.2 9980 2 2 1 3000 &") 

        net['server1'].cmd("nice -n -10 python3 tcp_core.py 10.0.6.2 9999 10000 1 SERVER TCP teste.pcap 1 &") 
        net['server2'].cmd("nice -n -10 python3 tcp_core.py 10.0.8.2 9999 10000 1 SERVER TCP teste.pcap 1 &") 
        
        time.sleep(8)

        print(net['server1'].cmd("nice -n -10 python3 background_sbd.py 'SERVER' 10.0.5.2 9999 1 2 1 3000 &"))
        print(net['server2'].cmd("nice -n -10 python3 background_sbd.py 'SERVER' 10.0.7.2 9980 2 2 1 3000 &"))

        print(net['client1'].cmd("nice -n -10 python3 tcp_core.py 10.0.6.2 9999 10000 1 CLIENT TCP testec.pcap 1 &"))
        print(net['client2'].cmd("nice -n -10 python3 tcp_core.py 10.0.8.2 9999 10000 1 CLIENT TCP testec.pcap 1 &"))
