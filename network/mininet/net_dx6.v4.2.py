...
class NetworkTopo( Topo ):
    ...
    # add frr node
        ...
        self.addLink(r7, r6, intfName1="r7-eth6", intfName2="r6-eth7", bw = 200)
        
        self.addLink(r2, r4, intfName1="r2-eth4", intfName2="r4-eth2")

        self.addLink(r4, r6, intfName1="r4-eth6", intfName2="r6-eth4" ,delay = '200ms')

        self.addLink(r3, r5, intfName1="r3-eth5", intfName2="r5-eth3")        

        self.addLink(r5, r6, intfName1="r5-eth6", intfName2="r6-eth5", bw = 200)
